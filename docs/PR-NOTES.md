...
Current model inputs drive white-background financial reports with sources, assumptions, scenarios, risks, sensitivity, KPI and page numbers. Existing eight guide PDFs and preview PNGs are refreshed; old guide URLs remain compatible.
