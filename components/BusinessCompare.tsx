...
const choices: CompareChoice[] = [
  ...businesses.map((business) => ({
    ...
    bep: business.bepMonths?`${business.bepMonths[0]}-${business.bepMonths[1]} bulan (estimasi skenario positif)`:"Belum tercapai",
    fee: "Usaha independen; biaya perizinan sesuai lokasi",
    ...
    basis: "CEK BISNIS ESTIMATE — biaya lokal belum disurvei",
